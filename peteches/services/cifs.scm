;; peteches/services/cifs.scm — CIFS client support service.
;;
...
(define-module (peteches services cifs)
...
(define (cifs-etc-files _)
  (list `("request-key.conf" ,(mixed-text-file "request-key.conf"
                                               "create dns_resolver * * "
                                               (file-append cifs-utils
                                                "/sbin/cifs.upcall")
                                               " %k\n"
                                               "create cifs.spnego  * * "
                                               (file-append cifs-utils

;; peteches/services/media-accounts.scm
;;
...
(define-module (peteches services media-accounts)
  #:use-module (gnu services)
  #:use-module (gnu services base)
  #:use-module (gnu system shadow)
  #:export (%media-gid media-accounts-service-type))

(define-public %media-gid
  490)

(define-public media-accounts-service-type
  (service-type (name 'media-accounts)
                (description
                 "Declare the shared `media' group (GID 490) for *Arr services.")

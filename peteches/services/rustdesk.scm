(define-module (peteches services rustdesk)
  ...
  #:export (rustdesk-configuration rustdesk-configuration?
...
(define-record-type* <rustdesk-configuration> rustdesk-configuration
                     make-rustdesk-configuration
...
(define (rustdesk-shepherd-services cfg)
  (let* ((package
           (rustdesk-configuration-package cfg))
    ...
    (list (shepherd-service (provision '(rustdesk-hbbs))
                            (requirement '(user-processes networking))
                            (documentation
                             "RustDesk rendezvous/ID server (hbbs)")
          ...
          (shepherd-service (provision '(rustdesk-hbbr))
                            (requirement '(user-processes networking))

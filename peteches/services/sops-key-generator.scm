;; peteches/services/sops-key-generator.scm
;;
...
(define-module (peteches services sops-key-generator)
...
(define sops-key-generator-service-type
  (service-type (name 'sops-key-generator)
                (extensions (list (service-extension
                                   shepherd-root-service-type
                                   (lambda (_)
                                     (list (shepherd-service (provision '(sops-key-generator))
                                                             (documentation
                                                              "Generate age keypair for SOPS on first boot only.")
                                                                          ...
                                                                          (if (and
                                                                           ...
                                                                           (begin
                                                                             ...
                                                                             (unless 
                                                                               ...
                                                                               (error
                                                                                "sops-key-generator: age-keygen failed"))
                                                                             (chmod
                                                                              key-file
                                                                              #o400)
                                                                                   ...
                                                                                   (
                                                                                    ...
                                                                                    (pub-key
                                                                                     (if
                                                                                      ...
                                                                                      (error
                                                                                       "sops-key-generator: unexpected key file format"))))
                ...
                (default-value #f)
                (description
                 "Generates an age keypair on first boot only.

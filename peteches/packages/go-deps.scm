  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "08kg20ycqarnaqv1gyrnpg3bry8nzqi866lmgwxhd90ghysrxkr5"))))
            ...
            (lambda _
              (let* ((out #$output)
                     (dest (string-append out
                                          "/src/github.com/mark3labs/mcp-go")))
                (mkdir-p dest)
...
(define-public go-github-com-yosida95-uritemplate
  (package
    ...
    (arguments
     (list
      #:import-path "github.com/yosida95/uritemplate"))
...
(define-public go-github-com-invopop-jsonschema
  (package
    ...
    (propagated-inputs (list go-github-com-wk8-go-ordered-map)) ;required at runtime/build
...
Golang structs to/from JSON without the use of reflection.")
    (license license:expat)))
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "0ckhf71wp1k4b8m7z400rbbm95gp0r831l9xvrnzfj0vbsc0b781"))))
    (build-system copy-build-system)
    (arguments
     (list
      #:phases
    ...
    (description
     "Stages google/go-github under GOPATH so downstream Go builds can import v74 packages offline.")
    (license license:bsd-3)))
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "07b3bjy1zqzpb05gq6bcc8s4b09b2ajia9vbyz61vfmiiynpiyxk"))))
    (build-system copy-build-system)
    (arguments
     (list
      #:phases
      #~(modify-phases %standard-phases
          (replace 'install
            (lambda _
              (let* ((out #$output)
                     (dest (string-append out
                            "/src/github.com/migueleliasweb/go-github-mock")))
                (mkdir-p dest)
                (copy-recursively "." dest)))))))
    (home-page "https://github.com/migueleliasweb/go-github-mock")
    (synopsis "Source bundle for go-github-mock")
    (description
     "Stages go-github-mock for offline builds that rely on google/go-github mocks.")
    (license license:expat)))
; MIT (verify on the tag you pin)
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "05ca46fzsdscdxaj64z039wwcbwafyvcl8dkmi8fcg10dswxns10"))))
    (build-system copy-build-system)
    (arguments
     (list
      #:phases
      #~(modify-phases %standard-phases
          (replace 'install
            (lambda _
              (let* ((out #$output)
                     (dest (string-append out
                                          "/src/github.com/shurcooL/githubv4")))
                (mkdir-p dest)
                (copy-recursively "." dest)))))))

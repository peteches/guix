...
(define-public shell-scripts
  (package
    ...
    (description
     "I like to use wofi to manage certain tasks and this package will install them for firefox, pass and screenshotting")
    (license gpl2)
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "09apl28c4hkrc8lfa209j8sagk26wyx1vnb5njfv7cj8kr6bckg9"))))

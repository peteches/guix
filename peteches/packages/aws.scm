...
(define-public aws-session-manager-plugin
  (let* ((version "1.2.764.0")
    ...
    (package
      ...
      (description
       "Client plugin the AWS CLI invokes for Systems Manager sessions, including port forwarding.")
      (license asl2.0))))

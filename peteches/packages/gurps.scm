  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "16l5x0mi639dqk22npsih48i23pq4nl6zq2r6isnqi1c2lwgqvqs"))))
...
"
    ...
    (description
     "GURPS Character Sheet (GCS) is a standalone character editor for GURPS 4e.")

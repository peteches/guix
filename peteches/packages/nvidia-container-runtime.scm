          ...
          (add-after 'unpack 'ensure-writable-source
            (lambda _
              ...
              (for-each make-file-writable
                        '("src/ldcache.c" "src/ldcache.h" "src/nvc_info.c"
                          "src/nvc.c" "mk/nvcgo.mk" "Makefile")) #t))
...
"))
            ...
            (lambda _
              ...
              (substitute* "Makefile"
                (("src/libnvidia-container\\.lds")
                 "-Wl,-T,src/libnvidia-container.lds")) #t))
            ...
            (lambda _
              (call-with-output-file "src/build.h"
                (lambda (p)
                  ...
                  (format p "#define BUILD_REVISION \"~a\"~%"
                          #$version)
    ...
    (description
     "The libnvidia-container library and tools used by the NVIDIA Container Toolkit.")
                ...
                (with-directory-excursion bin
                  (for-each (lambda (name)
                            ...
                            '("nvidia-container-runtime.legacy"
                              "nvidia-container-runtime.cdi")))) #t)))))
    (propagated-inputs (list libnvidia-container))
    (synopsis "Build and run containers leveraging NVIDIA GPUs")
    (description
     "NVIDIA Container Toolkit (includes nvidia-container-runtime and hooks).")

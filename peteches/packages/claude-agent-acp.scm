...
;; `cors' depends on `object-assign', which the importer confused with
;; the similarly-named but unrelated `object.assign' (node-object-assign
;; 4.1.7, from guix-science).  npm then failed to resolve object-assign
;; offline.  Defined here at the real latest version, 4.1.1.

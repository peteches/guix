(define-module (peteches home services aws)
  ...
  #:export (home-aws-configuration home-aws-service-type))
...
(define (home-aws-environment-variables-service-type config)
  `(("AWS_VAULT_BACKEND" unquote
     (home-aws-configuration-vault-backend config))
    ("AWS_VAULT_PASS_PREFIX" unquote
     (home-aws-configuration-vault-pass-prefix config))))

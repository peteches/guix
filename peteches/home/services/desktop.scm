...
(define (home-desktop-environment-variables config)
  (list `("XDG_SOUND_THEME_NAME" . "ocean")
...
(define (home-desktop-xdg-files config)
  (list `("gtk-3.0/settings.ini" ,(plain-file "gtk3-settings.ini"
        ...
        `("gtk-4.0/settings.ini" ,(plain-file "gtk4-settings.ini"
                                              (string-append "[Settings]\n"
                                               "gtk-enable-event-sounds = 1\n"
                                               "gtk-enable-input-feedback-sounds = 1\n"
                                               "gtk-sound-theme-name = ocean\n"
                                               ...
                                               "gtk-icon-theme-name=Papirus-Dark\n"
                                               "gtk-application-prefer-dark-theme=1\n")))
        `("Kvantum/kvantum.kvconfig" ,(plain-file "kvantum.kvconfig"

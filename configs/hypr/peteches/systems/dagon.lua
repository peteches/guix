-- Dagon's actual outputs (DP-1: PHL 32E1N1800LA, HDMI-A-1: VSC VP3268a-4K)
...
--
-- 2026-09-08: cables were swapped between the two ports, so the port ↔
-- monitor mapping flipped from the original (DP-1 was VSC, HDMI-A-1 was
-- PHL) — updated here to match.
--
-- VSC VP3268a-4K (HDMI-A-1) is primary and sits at the origin; PHL
-- 32E1N1800LA (DP-1) is physically mounted above it, so it gets a negative
-- Y offset equal to its own height to stack directly on top, left edges
-- flush.
--
